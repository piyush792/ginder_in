                ...
                <div class="item-content">
                    ...
                    <div class="item-content-wrapper">
                        <div class="form-group row frm-mobtab-topbot">
                            ...
                            <div class="col-sm-12 ctrl-field">
                                <?php
                                if($product_detail['Product']['featured_product']==1){
                                ?>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="featured-ad-1" name="" value="1" <?php echo ($this->request->data['Product']['featured_product']==1)?'checked':''; ?>>
                                ...
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="featured-ad-1" name="Product[featured_product]" value="1" <?php echo ($this->request->data['Product']['featured_product']==1)?'checked':''; ?> onclick="featuredProduct(this.value);">
                                    <label class="custom-control-label" for="featured-ad-1">Yes, I am interested</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="featured-ad-2" name="Product[featured_product]" value="0" <?php echo ($this->request->data['Product']['featured_product']==0)?'checked':''; ?> onclick="featuredProduct(this.value);">
