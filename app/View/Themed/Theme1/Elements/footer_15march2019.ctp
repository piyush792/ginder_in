...
<ins class="adsbygoogle"
     style="display:block"
     data-ad-client="ca-pub-3446985642161249"
     data-ad-slot="2767521575"
     data-ad-format="auto"
...
<section class="footer-wrapper">
    <section class="mega-footer">
        ...
        <div class="row mega-footer-row">
            <div class="col-sm-12 col-lg-2 footer-menu-heading"> <?php echo $key; ?> </div>
...
<section class="cookies-wrapper" id="cookies-policy">
    ...
    <div class="col-left">We use cookies at Ginder.in so we can provide content and advertising that's matters to you. You can find out more how cookies are used by clicking Cookie Settings. By using The Sun's website, you're agreeing to the use of cookies. <a href="ginder-privacy-policy.html">Privacy and Cookie Policy</a>
    </div>
    <div class="col-right">
