...
//                            }
                        ...
                        <div class="control-group" style="font-weight: bold;">
                            <label for="basic" class="control-label"><h4>* Draft:</h4></label>
                            <div class="controls">
                                <?php echo $this->Form->input('id', array('id' => 'id', 'options' => $draftNameList, 'empty' => 'Select Draft', 'onchange' => 'return gotourl(this.value);','selected' => !empty($this->request->params['pass'][0]) ? $this->request->params['pass'][0] : '', "style" => 'border: 2px solid;')); ?>
                            </div>
                        </div>
                        <hr />
                        <div class="control-group">
                            <label for="basic" class="control-label">* From Email Address:</label>
                            <div class="controls">
                                <?php echo $this->Form->input('from_email', array('id' => 'from_email')); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <label for="basic" class="control-label">* From Name:</label>
                            <div class="controls">
                                <?php echo $this->Form->input('from_name', array('id' => 'from_name')); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <label for="basic" class="control-label">* Subject:</label>
                            <div class="controls">
                                <?php echo $this->Form->input('subject', array('id' => 'subject')); ?>
                            </div>
                        </div>
                        <div class="alert alert-block alert-info">
                            <h4 class="alert-heading">Remark:</h4> 
                            Put these placeholders in email template body where you want the recipient to see the corresponding content.<br /><br />
                            <?php 
                            if(!empty($this->request->data) && $this->request->data['EmailTemplate']['id'] == 1){ 
                            ?>
                                <a href="javascript://" onclick="insertHTML('##first_name##');">##first_name##</a>,
                                <a href="javascript://" onclick="insertHTML('##activation_link##');">##activation_link##</a>,
                                <a href="javascript://" onclick="insertHTML('##user_id##');">##email_address##</a>,
                                <a href="javascript://" onclick="insertHTML('##password##');">##password##</a>
                         <?php
                           } 
                         ?>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <?php echo $this->Form->input('content', array('id' =>'content')); ?>
                            </div>
                        </div>
