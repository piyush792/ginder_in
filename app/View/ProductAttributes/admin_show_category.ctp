...
<div class="admin-middle-content">
    ...
    <div class="superadmin-adverts-wrapper">
      ...
      <?php echo $this->Html->link('<span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Back to Attribute Lists', array('controller' => 'product_attributes','action' => 'index'), array('escape' => false, 'class'=>'anchor-black header-anchor',"title"=>"Back to Attribute Lists")); ?>
        <header class="clearfix">
          <h2 class="section-heading">Show Attribute Category</h2>
        </header>
