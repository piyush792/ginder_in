...
<div class="admin-middle-content">
    ...
    <div class="superadmin-adverts-wrapper">
      ...
      <?php echo $this->Html->link('<span class="glyphicon glyphicon-arrow-left"></span>Back to Attribute Lists', array('controller' => 'product_attributes','action' => 'index'), array('escape' => false, 'class'=>'anchor-black header-anchor',"title"=>"Back to Attributes")); ?>
        <header class="clearfix">
          <h2 class="section-heading">Add New Attribute</h2>
        ...
        <section class="table-grid-wrapper">        
            <div class="item-content-wrapper">
                ...
                <div class="col-sm-12 col-lg-6 ctrl-field-adtitle">
                        <?php echo $this->Form->input('attribute_code',array('label'=>false,'id'=>'attribute_code','size'=>40,'class' => 'form-control'));?>
                    </div>
                </div>
                <div class="form-group row">
