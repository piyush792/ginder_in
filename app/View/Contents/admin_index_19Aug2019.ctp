...
<div class="admin-middle-content">
    <div class='admin-side-menu' id="admin-sidemenu-ctrl">
        ...
        <section class="superadmin-recent-ads-wrapper">
            ...
            <h2 class="section-heading">Web Page Management
            <?php echo $this->Html->link('<span class="glyphicon glyphicon-plus">', array('controller' => 'contents', 'action' => 'add'),array('escape' => false,"class"=>"btn-add-action icon-space-left","title"=>"Add New Category"));?>
            </h2>
            ...
            <section class="table-grid-wrapper">        
                <div class="box-head">
                    <?php echo $this->Form->create("Content",array('url'=>'index/','type'=>'post'));?>
