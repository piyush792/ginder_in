...
<div class="admin-middle-content">
    ...
    <div class="superadmin-adverts-wrapper">
      ...
      <?php echo $this->Html->link('<span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Back to Web Page', array('controller' => 'contents','action' => 'index'), array('escape' => false, 'class'=>'anchor-black header-anchor',"title"=>"Back to Users")); ?>
        <header class="clearfix">
          <h2 class="section-heading">Add New Page</h2>
        ...
        <?php echo $this->Form->create('Content',array('id'=>'Content','class' => 'form-horizontal')); ?>        
