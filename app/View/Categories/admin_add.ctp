...
{        
    if($("#name").val()=="")
    {
        $("#error_msg").html("<div class='alert alert-info alert-block'><a class='close' data-dismiss='alert' href='#'>x</a>Please enter Resource Type name</div>");
        return false;
    }    
}
</script>
            ...
            <div class="item-content-wrapper">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-lg-6 ctrl-field-adtitle">
                        <?php echo $this->Form->input('parent_id',array('label'=>false,'id'=>'parent_id','options'=>array($catoptions), 'class'=>'form-control', "default"=>$parent_id,"div"=>false));?>
                    </div>
                </div>
                <div class="form-group row">
