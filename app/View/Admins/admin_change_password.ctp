    ...
    <div class="item-content">
                    ...
                    <div class="item-content-wrapper">
                        ...
                        <div class="form-group row">
                            <label for="basic" class="col-sm-2 col-form-label">New Password</label>
                            <div class="col-sm-12 col-lg-6 ctrl-field-adtitle">
                                <?php echo $this->Form->input('password',array('label'=>false,'id'=>'password',"div"=>false,'size'=>40,"class"=>"form-control"));?>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="basic" class="col-sm-2 col-form-label">Re-enter Password:</label>
                            <div class="col-sm-12 col-lg-6 ctrl-field-adtitle">
                                <?php echo $this->Form->input('confirm_password',array('label'=>false,'type'=>'password','id'=>'confirm_password',"div"=>false,'size'=>40,"class"=>"form-control"));?>
                            </div>
                        </div>
