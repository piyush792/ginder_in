                ...
                <div class="box">
                    <div class="box-content box-nomargin" style="padding-top:20px;">
                        ...
                        if(count($productList)>0){
                            ?>
                            <?php echo $this->Form->create('Product',array('id'=>'Product', 'url' => '', 'class'=>'form-horizontal')); ?>
                            <table class='table table-striped table-bordered'>                     
                                ...
                                <tbody>
                                    ...
                                    {
                                        // echo $this->Form->input('product_id[]',array('label'=>false,'id'=>'product_id',"div"=>false,'size'=>40,"class"=>"input-square", "value"=>$productList[$i]['Product']['id']));
                                        // echo $this->Form->input('user_email_id[]',array('label'=>false,'id'=>'user_email_id',"div"=>false,'size'=>40,"class"=>"input-square", "value"=>$productList[$i]['User']['email']));
                                        echo "<input type='hidden' name='product_id[]' value= '".$productList[$i]['Product']['id']."' />";
                                        // echo "<input type='hidden' name='user_email_id[]' value= '".$productList[$i]['User']['email']."' />";
                                        echo "<tr>";
                            ...
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="form-actions">
                                        <?php echo $this->Form->input("Reminder Mail",array('type'=>'submit','label'=>false,'class'=>'btn btn-primary',"div"=>false,'title'=>'Search', 'style'=>'float:left;'));?>&nbsp;&nbsp;
                                    </div>
                                </div>
                            </div>
