...
// echo "<pre>";
// print_r($retailUsersList); exit;
if (count($retailUsersList) > 0)
{
    foreach ($retailUsersList as $data)
    {
        $results_grid[] = array(
    ...
    <div class="superadmin-adverts-wrapper">
      ...
      <section class="superadmin-recent-ads-wrapper">
        <header class="clearfix">
          <h2 class="section-heading">Retail Users (<?php echo count($retailUsersList); ?>)</h2>
