...
Class ProductsController extends AppController {
    ...
    var $uses = array("Product", "ProductAttribute", "ProductAttributeRelation", "ProductAttributeValue", "Category", "CategoriesProduct", "WishList", "User",
        "ProductImage", "EmailTemplate", "Rating", "ProductContact","State","City", "SocialLink", "SpamReport");
    ...
    public function beforeFilter() {
        ...
        if ((isset($this->request->params['prefix']) && ($this->request->params['prefix'] == 'admin'))) {
            ...
            $this->Auth->allow("view", "product_list", 'product_popup', "detail", "wish_list", 'remove_wishlist', 'check_quantity', 'search', 'searchajax', 'post_an_ad', 'get_captcha', 'spam_report', 'product_interested');
        }
    }
