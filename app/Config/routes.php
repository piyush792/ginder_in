 ...
 */
    ...
    Router::connect('/admin', array('controller' => 'admins', 'action' => 'index', 'admin' => true));
    Router::connect('/admin/index', array('controller' =>'admins', 'action' => 'index','admin'=>true));   
    ...
    Router::connect('/:permalink', array('controller' => 'contents', 'action' => 'index','admin'=>false),array('permalink' => '[A-Za-z0-9-_]+'));
 /**
